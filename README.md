...
## Instalar Utilidades de Admin
    	...
    	sudo apt install timeshift tlp btrfs-progs gparted gsmartcontrol bleachbit acpi arandr xfce4 lightdm network-manager-gnome network-manager htop wget
